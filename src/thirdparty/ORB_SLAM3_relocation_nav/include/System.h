...
public:
    ...
    System(const string &strVocFile, const string &strSettingsFile, const bool mode1, const bool mode2, const eSensor sensor, const bool bUseViewer = true, const int initFr = 0, const string &strSequence = std::string());
