...
PathPlanning::PathPlanning() :
  ...
  get_path_in_zone_srv_ = nh.advertiseService("akm_zone_path", &PathPlanning::get_path_in_zone, this);
...
int main(int argc, char** argv) {
  ros::init(argc, argv, xmi::planning::PLANNER_NODE_NAME);
  xmi::planning::PathPlanning path_planning;
