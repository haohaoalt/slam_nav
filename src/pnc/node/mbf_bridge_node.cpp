...
public:
  MbfBridge() {
    ...
    ros::NodeHandle nh("/");
    keep_out_zone_srv_ = nh.advertiseService("akm_zone", &MbfBridge::keepOutZoneSrv, this);
    local_keep_out_ = nh.serviceClient<costmap_2d::keepOutZone>(
      "/move_base_flex/local_costmap/keep_out_layer/akm_zone");
    global_keep_out_ = nh.serviceClient<costmap_2d::keepOutZone>(
      "/move_base_flex/global_costmap/keep_out_layer/akm_zone");
  }
...
int main(int argc, char** argv) {
  ros::init(argc, argv, "akm_mbf_bridge");

  akm::pnc::MbfBridge _bridge;
  ros::spin();
