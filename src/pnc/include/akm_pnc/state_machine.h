...
#include "akm_pnc/akm_task.h"

namespace akm::pnc {
constexpr static const char* NODE_NAME = "akm_state_machine";
...
constexpr static const char* TASK_SRV = "akm_task";
...
private:
  ...
  auto task_service(akm_pnc::akm_task::Request& req, akm_pnc::akm_task::Response& resp) -> bool;
